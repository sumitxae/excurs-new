...
public class HttpLogger {
    ...
    public void logScanData(String deviceMac, float temperature, int battery, String firmwareVersion, int rssi) {
        try {
            ...
            logData.put("timestamp", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(new Date()));
    ...
    public void logCompleteDeviceData(String deviceMac, String deviceName, float temperature, String firmware, 
        ...
        Log.d(TAG, "Device details - Name: " + deviceName + ", Temp: " + temperature + ", Battery: " + battery + ", RSSI: " + rssi);
    ...
    private void sendFullDataInChunks(String deviceMac, String deviceName, float temperature, String firmware, 
        ...
        try {
            ...
            for (int chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++) {
                ...
                historicalChunk.put("timestamp", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(new Date()));
            ...
            if (!excursions.isEmpty()) {
                ...
                for (int chunkIndex = 0; chunkIndex < totalExcursionChunks; chunkIndex++) {
                    ...
                    excursionChunk.put("timestamp", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(new Date()));
            ...
            completionMarker.put("timestamp", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(new Date()));
            ...
            completionMarker.put("totalExcursionChunks", excursions.isEmpty() ? 0 : (int) Math.ceil((double) excursions.size() / 500));
        ...
        executor.execute(() -> {
            try {
                ...
                try (Response response = client.newCall(request).execute()) {
                    Log.d(TAG, "HTTP response received - Code: " + response.code() + ", Message: " + response.message());
